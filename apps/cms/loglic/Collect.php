...
class Collect
{
    ...
    */
    public function apiCategory($url='', $token='')
    {
        ...
        $this->error = DcEmpty($json['msg'],lang('collect_error_404'));
        return $json['data'];
    }
    ...
    */
    public function apiUrl($url='', $action='category', $token='')
    {
        ...
        if($url['host'] == 'api.daicuo.cc'){
            ...
            $query = '?s=cms/data/'.$action.'&token='.DcEmpty($token,config('common.site_token'));
        }
        if($url['query']){
            $query .= '&'.$url['query'];
        }
    ...
    * @return bool
    */
    public function apiReferer($cmsReferer='')
    {
        //无数据直接pase
        if(!$cmsReferer){
            $this->error = '无来源';
        ...
        $where['info_meta_value'] = ['eq',$cmsReferer];
    ...
    public function fields($data=[])
    {
        return [
            ...
            'collect_url' => [
                ...
                'placeholder'     => lang('collect_url_tips'),
                'data-filter'     => false,
                'data-visible'    => true,
                'data-align'      => 'left',
                'data-class'      => 'text-wrap',
            ...
            'collect_token' => [
                ...
                'placeholder'     => lang('collect_token_tips'),
                'data-filter'     => false,
                'data-visible'    => true,
                'data-align'      => 'left',
                'data-class'      => 'text-wrap',
            ...
            'collect_category' => [
                ...
                'rows'            => 10,
                'placeholder'     => lang('collect_category_tips'),
                'data-filter'     => false,
                'data-visible'    => true,
                'data-align'      => 'left',
                'data-class'      => 'text-wrap',
