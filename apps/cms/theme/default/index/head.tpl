...
<title>头条文章－{:config('common.site_name')}</title>
<meta name="keywords" content="{:config('common.site_name')}头条新闻" />
<meta name="description" content="{:config('common.site_name')}头条新闻！" />
{/block}
...
<div class="container">
  <ol class="breadcrumb bg-white mb-3">
    ...
    <li class="breadcrumb-item active">头条文章</li>
  </ol>
  <ol class="bg-white mb-3 px-5 py-3">
  {volist name=":cmsSelect(['status'=>'normal','limit'=>100,'sort'=>'info_create_time','order'=>'desc','meta_key'=>'cms_head','meta_value'=>'1'])" id="cms"}
