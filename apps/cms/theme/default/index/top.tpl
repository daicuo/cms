...
<title>置顶文章－{:config('common.site_name')}</title>
<meta name="keywords" content="{:config('common.site_name')}置顶文章" />
<meta name="description" content="{:config('common.site_name')}置顶的100条文章！" />
{/block}
...
<div class="container">
  <ol class="breadcrumb bg-white mb-3">
    ...
    <li class="breadcrumb-item active">置顶文章</li>
  </ol>
  <ol class="bg-white mb-3 px-5 py-3">
  {volist name=":cmsSelect(['status'=>'normal','limit'=>100,'sort'=>'info_create_time','order'=>'desc','meta_key'=>'cms_top','meta_value'=>1])" id="cms"}
