...
<div class="container">
  ...
  {if $user['user_id']}
    {assign name="navbars" value=":cmsNavsSelect(['type'=>'navbar','status'=>['in','normal,private']])" /}
  {else/}
    {assign name="navbars" value=":cmsNavsSelect(['type'=>'navbar','status'=>['in','normal,public']])" /}
  {/if}
